...
export const serverSchema = z.object({
    ...
    LOCAL_SIGNIN_PASSWORD: z.string().min(1).trim().optional(),
...
export const serverEnv = {
    ...
    LOCAL_SIGNIN_PASSWORD: process.env.LOCAL_SIGNIN_PASSWORD,
...
export const clientSchema = z.object({
    ...
    NEXT_PUBLIC_VERCEL_ENV: z.enum(["production", "preview", "development", "test"]).default("production"),
    ...
    NEXT_PUBLIC_BACKEND_URL: z.string().min(1).default("/platform"),
