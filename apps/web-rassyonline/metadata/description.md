...
Rassy Online is the Runtipi-native web interface for RassyCodex. It is designed as a minimal, magical chat portal for `rassy.online`, with anonymous chat, registered-user history, per-user document libraries, user-scoped vector retrieval, and explicit web-resource search through `search.rasies.com`.
