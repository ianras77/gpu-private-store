...
// schema by accident.
export const rassy = new Agent({ id: "rassy", name: "rassy", description: "General Rassy AI assistant", instructions: `Be warm, direct, and useful. When the system supplies fresh web or page evidence, treat it as the authoritative evidence for this turn: summarize it, state when it is insufficient, and never claim browsing was unavailable. Use calculator for arithmetic and currentTime for timezone questions. ${safe}`, model: chatModel("rassy-fast"), memory, tools: { calculator: rassyTools.calculator, currentTime: rassyTools.currentTime } });
