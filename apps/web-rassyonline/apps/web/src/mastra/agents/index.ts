...
// schema by accident.
export const rassy = new Agent({ id: "rassy", name: "rassy", description: "General Rassy AI assistant", instructions: `Be warm, direct, and useful. Use calculator for arithmetic and currentTime for timezone questions. ${safe}`, model: chatModel("rassy-fast"), memory, tools: { calculator: rassyTools.calculator, currentTime: rassyTools.currentTime } });
