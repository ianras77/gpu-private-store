...
- Mr Rassy hardening: global library/radio playback exclusion; bounded library fetch; RassyMind aliases; truthful stream manifest; token-safe distributed queue-fill lock; radio controller lint, 61 tests, and build passed.
