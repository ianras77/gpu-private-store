...
const config = {
    ...
    LLM_BASE_URL: process.env.LLM_BASE_URL ?? "http://ollama-proxy:8080",
    LLM_MODE: normalizeMode(process.env.LLM_MODE),
    LLM_MODEL: process.env.LLM_MODEL ?? "gpt-oss:20b",
    LLM_API_KEY: process.env.LLM_API_KEY ?? "",
    EMBED_BASE_URL: process.env.EMBED_BASE_URL ?? "http://ollama-proxy:8080",
